...
namespace TestProjectXUnit
{
    ...
    public class XUnitTestInitCleanupTest : IDisposable, IClassFixture<ClassSharedContext>
    {
        private readonly ClassSharedContext _classSharedContext;
        private readonly CollectionSharedContext _collectionSharedContext;

        public XUnitTestInitCleanupTest(ClassSharedContext classSharedContext, CollectionSharedContext collectionSharedContext)
        {
